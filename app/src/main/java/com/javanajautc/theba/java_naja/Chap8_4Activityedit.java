...
public class Chap8_4Activityedit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chap8_4edit);
        ...
        Nextpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Next = new Intent(Chap8_4Activityedit.this, Chap8_5Activity.class);
                startActivity(Next);
...
//if left to right sweep event on screen
                if (x1 < x2) {
                    ...
                    Intent i = new Intent(Chap8_4Activityedit.this, Chap8_3Activity.class);
                    startActivity(i);
...
// if right to left sweep event on screen
                if (x1 > x2) {
                    ...
                    Intent i = new Intent(Chap8_4Activityedit.this, Chap8_5Activity.class);
                    startActivity(i);
                    overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                }
